...
set COMPILE_FLAGS="-fbounds-check -Wuninitialized -O2 -static -fopenmp -m64 -traceback"
set LINK_FLAGS= "-static -O2 -m64 -fopenmp"

\rm aermod.exe 

gfortran -c $COMPILE_FLAGS modules.f    
gfortran -c $COMPILE_FLAGS grsm.f
gfortran -c $COMPILE_FLAGS grs7_main.f 
gfortran -c $COMPILE_FLAGS grs7_supl.f
...
gfortran -o aermod.exe $LINK_FLAGS modules.o grsm.o grs7_main.o grs7_supl.o aermod.o setup.o coset.o soset.o reset.o meset.o ouset.o inpsum.o metext.o iblval.o siggrid.o tempgrid.o windgrid.o calc1.o calc2.o prise.o arise.o prime.o sigmas.o pitarea.o uninam.o output.o evset.o evcalc.o evoutput.o rline.o bline.o
